...
const DemoComputer = (props) => {
    ...
    useGSAP(() => {
        gsap.from(group.current.rotation, {
            ...
            duration: 1,
            ease: 'power3.out'
        }); // Removed the incorrect dependencies object here
    }, [txt]); // <-- Dependencies array should be the third argument to useGSAP
    // The dependency `txt` will re-run the animation if the texture changes.
